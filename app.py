...
#  'release_year', 'release_month', 'release_day_of_week', 'main_actor_encoded']
...
def process_form_data(form, director, lead_actor):
    ...
    # data['director_encoded'] = director_encoder.transform(wow)
    # dat = {"main_actor": [lead_actor]}
    # wow = pd.DataFrame(dat)
    # data['main_actor_encoded'] = actor_encoder.transform(wow)
